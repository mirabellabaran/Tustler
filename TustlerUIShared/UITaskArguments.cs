...
{
    /// <summary>
    /// An 'enum' of possible modes; SetArgument mode takes an argument
    /// </summary>
    public class UITaskMode
    {
        ...
        public static UITaskMode RestartTask { get { return new UITaskMode(UITaskMode.Tags.RestartTask); } }
