...
///// A reference to a set of languages for the Translation service MG used AWSIterationStack instead
//type TranslationTargetLanguageCodes(languages: IEnumerable<LanguageCode>) =
//    let mutable _languages = languages

//    member this.Languages with get() = _languages and set(value) = _languages <- value

//    new() = TranslationTargetLanguageCodes(null)
