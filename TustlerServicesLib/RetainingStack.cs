...
namespace TustlerServicesLib
{
    ...
    //    public string UnderlyingTypeString { get; }
    //    public void Consume();      // consume the current item
    //}

    //public class SerializationWrapper<T>
    //{
    //    private readonly RetainingStack<T> _retainingStack;

    //    public SerializationWrapper(RetainingStack<T> retainingStack)
    //    {
    //        _retainingStack = retainingStack;
    //    }

    //    public static SerializationWrapper<T> CastFrom(IConsumable consumable)
    //    {
    //        var actualType = consumable.GetType();
    //        var genericTypeArguments = actualType.GetGenericArguments();
    //        var constructedType = consumable.GetType().MakeGenericType(genericTypeArguments);
    //        var stack = Activator.CreateInstance(constructedType);

    //        //var stack = Convert.ChangeType(consumable, consumable.GetType().UnderlyingSystemType);
    //        return new SerializationWrapper<T>(stack);
    //    }

    //    public int Total => _retainingStack.Total;

    //    public int Remaining => _retainingStack.Remaining;

    //    public string UnderlyingTypeString => _retainingStack.UnderlyingTypeString;

    //    public IEnumerable<T> Data => _retainingStack.AsEnumerable();
    //}
