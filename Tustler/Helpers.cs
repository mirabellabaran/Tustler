...
namespace Tustler.Helpers
{
    ...
    public static class FileServices
    {
        ...
        public static string GetMimeType(string sFilePath)
        {
            ...
            {
                sMimeType = NativeMethods.GetMimeTypeFromFile(sFilePath);
        ...
        public static string GetMimeTypeFromList(string sFileNameOrPath)
        {
            ...
            string sExtensionWithoutDot = Path.GetExtension(sFileNameOrPath).Substring(1).ToLowerInvariant();
    ...
    internal static class NativeMethods
    {
        ...
        public static string GetMimeTypeFromFile(string sFilePath)
        {
            ...
            // at this point, GetMimeTypeFromList() will have already detected text files from the extension
            if (!String.IsNullOrEmpty(mime) && mime != "text/plain" && mime != "application/octet-stream")
            {
                return mime;
            }
